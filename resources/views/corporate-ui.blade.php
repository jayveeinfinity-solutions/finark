...
<html lang="en">
    ...
    @inertia
    <!--   Core JS Files   -->
    <script src="{{ asset('js/corporate-ui/plugins/perfect-scrollbar.min.js') }}"></script>
    <script src="{{ asset('js/corporate-ui/plugins/smooth-scrollbar.min.js') }}"></script>
    <script src="{{ asset('js/corporate-ui/plugins/chartjs.min.js') }}"></script>
    <script src="{{ asset('js/corporate-ui/plugins/swiper-bundle.min.js') }}" type="text/javascript"></script>
    <script>
    ...
    <script src="{{ asset('js/corporate-ui/corporate-ui-dashboard.min.js?v=1.0.0') }}"></script>
</html>