<template>
  <Head title="Partner &sdot; Admin Panel &sdot; " />
  <div class="container-fluid py-4 px-5">
    <AdminHeader />
    <!-- <div class="row">
      <div class="col-12">
        <div class="card card-background card-background-after-none align-items-start mt-4 mb-5">
          <div class="full-background" style="background-image: url('https://demos.creative-tim.com/corporate-ui-dashboard/assets/img/header-blue-purple.jpg');"></div>
          <div class="card-body text-start p-4 w-100">
            ...
            <img src="https://demos.creative-tim.com/corporate-ui-dashboard/assets/img/3d-cube.png" alt="3d-cube" class="position-absolute top-0 end-1 w-25 max-width-200 mt-n6 d-sm-block d-none" />
          </div>
        </div>
      </div>
    </div> -->
        ...
        <div class="card border shadow-xs mb-4">
          <div class="card-header border-bottom pb-0">
            <div class="d-sm-flex align-items-center">
              <div>
                <h6 class="font-weight-semibold text-lg mb-0">Partners list ({{ partners.total }})</h6>
                <p class="text-sm">See information about all partners</p>
              </div>
              <div class="ms-auto d-flex">
                <button type="button" class="btn btn-sm btn-white me-2">
                  View all
                </button>
                <a href="/admin/partners/create" class="btn btn-sm btn-dark btn-icon d-flex align-items-center me-2">
                  <span class="btn-inner--icon">
          ...
          <div class="card-body px-0 py-0">
            ...
            <div class="table-responsive p-0">
              <table class="table align-items-center mb-0">
                <thead class="bg-gray-100">
                  <tr>
                    <th class="text-secondary text-xs font-weight-semibold opacity-7">Partner</th>
                ...
                <tbody>
                  <tr v-for="partner in partners.data" :key="partner.id">
                    <td>
                      <div class="d-flex px-2 py-1">
                        ...
                        <div class="d-flex flex-column justify-content-center ms-1">
                          ...
                          <!-- <p class="text-sm text-secondary mb-0">{{ partner.url }}</p> -->
                        </div>
                      </div>
                    </td>
                    ...
                    <td class="align-middle">
                      <a :href="'/admin/partners/' + partner.id + '/edit'" class="text-secondary font-weight-bold text-xs" data-bs-toggle="tooltip" data-bs-title="Edit user">
            ...
            <Pagination :links="partners.links" :prevLink="partners.prev_page_url" :nextLink="partners.next_page_url" :lastPage="partners.last_page" />
          </div>
        </div>
      </div>
    </div>
...
<script setup>
  ...
  watch(search, debounce(function (value) {
    router.get('/admin/partners', { search: value, },
      { preserveState: true }
    );
  }, 300));
</script>
