<template>
    <Head title="Clients &sdot; Admin Panel &sdot; " />
          ...
          <div class="card shadow-xs mb-4">
            <div class="card-header border-bottom pb-0">
              <div class="d-sm-flex align-items-center">
                <div>
                  <h6 class="font-weight-semibold text-lg mb-0">Client list ({{ clients.length ?? 0 }})</h6>
                  <p class="text-sm">See information about all clients</p>
                </div>
                <div class="ms-auto d-flex">
                  <!-- <button type="button" class="btn btn-sm btn-white me-2">
                    View all
                  </button> -->
                  <!-- <a href="/admin/client/create" class="btn btn-sm btn-dark btn-icon d-flex align-items-center me-2">
                    ...
                    <tr v-for="client in clients" :key="client.id">
                        <td class="align-middle">
                            <div class="d-flex px-2">
                                ...
                                <div class="my-auto">
                                    <div class="px-2">
                                        <p class="text-dark fw-bold text-sm mb-0">{{ client.name }}</p>
                                        <p class="text-secondary text-sm mb-0">{{ client.email }}</p>
                                    </div>
                                </div>
                            </div>
                        </td>
