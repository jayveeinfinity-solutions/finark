        ...
        <div class="container-fluid py-1 px-2">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-1 pb-0 pt-1 px-0 me-sm-6 me-5">
                    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="/admin">FinArk</a></li>
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page" v-for="page in pages" :key="page.id">{{ page.name }}</li>
                </ol>
                ...
                <ul class="navbar-nav  justify-content-end">
                    ...
                    <li class="nav-item dropdown pe-2 d-flex align-items-center">
                        ...
                        <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
                            <p class="m-0 text-center">No notifications</p>
                            <!-- <li class="mb-2">
